...
export default function ForgotPassword() {
  ...
  function validate() {
    ...
    if (!pwRegex.test(newPassword)) return "Password must be 8+ characters with uppercase, lowercase, and a special character."
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) { setError(data?.message || "Failed to reset password. Please try again.") }
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .glass-title { font-size:1.6rem;font-weight:600;text-align:center;background-size:200% 200%;animation:shimmerText 3s ease-in-out infinite alternate;margin-bottom:0.5rem;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text; }
        ...
        .glass-subtitle { font-size:0.875rem;text-align:center;margin-bottom:1.5rem;animation:fadeDown 0.5s ease 0.2s both;opacity:0; }
        .dark  .glass-subtitle { color:rgba(255,255,255,0.4); } .light .glass-subtitle { color:rgba(79,70,229,0.6); }
        ...
        .glass-input-wrap:nth-child(1){animation-delay:0.2s;} .glass-input-wrap:nth-child(2){animation-delay:0.3s;} .glass-input-wrap:nth-child(3){animation-delay:0.4s;} .glass-input-wrap:nth-child(4){animation-delay:0.5s;}
        ...
        .footer-text { font-size:0.85rem;text-align:center;margin-top:1.5rem; }
      ...
      <div className={`glass-page ${d ? "dark" : "light"}`}>
        ...
        <div className="glass-card">
          ...
          <h2 className="glass-title">Reset Your Password</h2>
          <p className="glass-subtitle">Enter your email and set a new password to regain access.</p>
          ...
          <form style={{display:"flex",flexDirection:"column",gap:"1rem"}} onSubmit={handleSubmit}>
            ...
            <div className="glass-input-wrap">
              <input className="glass-input" type="password" placeholder="New Password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} required />
              <p className="glass-hint">8+ chars, uppercase, lowercase &amp; special character</p>
            </div>
            <div className="glass-input-wrap">
              <input className="glass-input" type="password" placeholder="Confirm New Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
            </div>
            <div className="glass-input-wrap">
