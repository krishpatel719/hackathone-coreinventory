        ...
        <div className="content">
          <aside className="sidebar">
            ...
            <nav>
              ...
              <Link href="/dashboard/delivery" className="nav-link active">Delivery Orders</Link>
          ...
          <main className="main-content">
            <div className="topbar">
              <div>
                ...
                <p className="page-subtitle">Manage outgoing shipments and reduce stock automatically</p>
              </div>
            ...
            <div className="filter-row">
              <input className="glass-input" placeholder="Search delivery ID or customer..." style={{width:"260px"}} />
              <select className="glass-select"><option>Status</option><option>Draft</option><option>Picking</option><option>Packing</option><option>Done</option><option>Canceled</option></select>
              <select className="glass-select"><option>Warehouse</option><option>Main Warehouse</option><option>Production Floor</option></select>
            </div>

            <div className="table-wrap">
              <table>
                <thead><tr><th>Delivery ID</th><th>Customer</th><th>Products</th><th>Warehouse</th><th>Status</th><th>Created Date</th><th>Actions</th></tr></thead>
                <tbody>
                  <tr>
                    <td style={{fontWeight:600}}>DEL-001</td>
                    <td>ABC Furniture Ltd</td>
                    <td>Chairs (10)</td>
                    <td>Main Warehouse</td>
                    <td><span className="badge badge-yellow">Picking</span></td>
                    <td>2026-03-14</td>
                    <td style={{display:"flex",gap:"0.5rem"}}>
                      <button className="btn-outline-sm">View</button>
                      <button className="btn-sm" style={{background:"linear-gradient(135deg,#2563eb,#3b82f6)",color:"white"}}>Pack</button>
                      <button className="btn-sm" style={{background:"linear-gradient(135deg,#059669,#10b981)",color:"white"}}>Validate</button>
                    </td>
                  </tr>
                  <tr>
                    <td style={{fontWeight:600}}>DEL-002</td>
                    <td>Modern Office Supplies</td>
                    <td>Tables (5)</td>
            ...
            <div className="glass-card workflow">
              <p className="section-title">Delivery Workflow</p>
              <ol><li>Pick items from warehouse</li><li>Pack items for shipment</li><li>Validate delivery → stock decreases automatically</li></ol>
            </div>
          </main>
        </div>
      </div>
