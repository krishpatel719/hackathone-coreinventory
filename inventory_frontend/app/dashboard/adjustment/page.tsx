    ...
    <>
      <style>{`
        ...
        * { box-sizing:border-box;margin:0;padding:0; }
        ...
        .glass-input{border-radius:10px!important;font-family:'Outfit',sans-serif!important;font-size:0.9rem!important;transition:all 0.3s ease;outline:none;padding:0.55rem 0.9rem!important;width:100%;}
        ...
        .glass-select{border-radius:10px;font-family:'Outfit',sans-serif;font-size:0.9rem;padding:0.55rem 0.9rem;transition:all 0.3s;outline:none;cursor:pointer;width:100%;}
        ...
        .table-wrap{border-radius:16px;border:1px solid;overflow:hidden;transition:all 0.4s;margin-bottom:1.5rem;}
        ...
        <div className="content">
          <aside className="sidebar">
            ...
            <nav>
              ...
              <Link href="/dashboard/adjustment" className="nav-link active">Inventory Adjustment</Link>
          ...
          <main className="main-content">
            <div className="topbar">
              <div>
                ...
                <p className="page-subtitle">Correct mismatches between recorded stock and physical inventory</p>
              </div>
            ...
            <div className="glass-card">
              <p className="section-title">Create Stock Adjustment</p>
              <div className="form-grid">
                <select className="glass-select"><option>Select Product</option><option>Steel Rod</option><option>Iron Plate</option></select>
                <select className="glass-select"><option>Select Warehouse</option><option>Main Warehouse</option><option>Production Floor</option></select>
                <input className="glass-input" placeholder="Recorded Quantity" />
                <input className="glass-input" placeholder="Counted Quantity" />
              </div>
              <div style={{marginBottom:"1rem"}}>
                <input className="glass-input" placeholder="Reason (damage, loss, correction...)" />
              </div>
            ...
            <div className="table-wrap">
              <table>
                <thead><tr><th>Adjustment ID</th><th>Product</th><th>Warehouse</th><th>Recorded Qty</th><th>Counted Qty</th><th>Difference</th><th>Reason</th><th>Date</th></tr></thead>
                <tbody>
                  <tr>
                    <td style={{fontWeight:600}}>ADJ-001</td>
                    <td>Steel Rod</td><td>Main Warehouse</td><td>100</td><td>97</td>
                    <td style={{color:"#f87171",fontWeight:600}}>-3</td>
                    <td>Damaged items</td><td>2026-03-14</td>
                  </tr>
                  <tr>
                    <td style={{fontWeight:600}}>ADJ-002</td>
                    <td>Iron Plate</td><td>Production Floor</td><td>50</td><td>55</td>
                    <td style={{color:"#4ade80",fontWeight:600}}>+5</td>
                    <td>Stock recount</td><td>2026-03-13</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="glass-card workflow">
              <p className="section-title">Adjustment Workflow</p>
              <ol><li>Select product and warehouse</li><li>Enter recorded stock and counted stock</li><li>System calculates the difference</li><li>Adjustment is applied and logged in stock ledger</li></ol>
            </div>
          </main>
        </div>
      </div>
