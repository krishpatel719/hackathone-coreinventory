        ...
        <div className="content">
          <aside className="sidebar">
            ...
            <nav>
              ...
              <Link href="/dashboard/receipts" className="nav-link active">Receipts</Link>
          ...
          <main className="main-content">
            <div className="topbar">
              <div>
                ...
                <p className="page-subtitle">Record incoming inventory from suppliers and update stock automatically</p>
              </div>
            ...
            <div className="filter-row">
              <input className="glass-input" placeholder="Search receipt ID or supplier..." style={{width:"260px"}} />
            ...
            <div className="table-wrap">
              <table>
                <thead><tr><th>Receipt ID</th><th>Supplier</th><th>Products</th><th>Warehouse</th><th>Status</th><th>Created Date</th><th>Actions</th></tr></thead>
                <tbody>
                  <tr>
                    <td style={{fontWeight:600}}>RCPT-001</td>
                  ...
                  <tr>
                    <td style={{fontWeight:600}}>RCPT-002</td>
                    <td>Metal Traders Ltd</td>
                    <td>Iron Plate (30)</td>
            ...
            <div className="glass-card workflow">
              <p className="section-title">Receipt Workflow</p>
              <ol><li>Create a new receipt</li><li>Add supplier and products</li><li>Enter quantities received</li><li>Validate receipt → stock increases automatically</li></ol>
            </div>
          </main>
        </div>
      </div>
